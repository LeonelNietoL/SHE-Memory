...
def generate_message(info:MemoryUpdateInfo, KEY_UPDATE_ENC_C:bytes, KEY_UPDATE_MAC_C:bytes) -> MemoryUpdateMessage :
...
def generate_message_basic(info:MemoryUpdateInfo) -> MemoryUpdateMessage :
    """
    Function to generate memory update procol message (Basic SHE)

    Args:
        info: MemoryUpdateInfo->class

    Return:
        generate_message(): MemoryUpdateMessage->class
    """
